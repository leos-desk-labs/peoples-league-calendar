...
export function Header({ onExport, onImport, currentUser, onChangeUser, presenceSlot }) {
  const handleImport = () => {
  ...
  return (
    <header className="header">
      ...
      <div className="header-right">
        {currentUser && (
          <button className="header-user-badge" onClick={onChangeUser} title="Change user">
            <span className="header-user-avatar">{currentUser.charAt(0)}</span>
